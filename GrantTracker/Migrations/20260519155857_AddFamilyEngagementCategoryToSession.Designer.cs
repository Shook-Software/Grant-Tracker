...
namespace GrantTracker.Migrations
{
    ...
    [Migration("20260519155857_AddFamilyEngagementCategoryToSession")]
    partial class AddFamilyEngagementCategoryToSession
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GrantTracker.Dal.Schema.FamilyEngagementCategory", b =>
                {
                    b.Property<Guid?>("Guid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.ToTable("FamilyEngagementCategory", "GTkr", t =>
                        {
                            t.HasComment("Lookup table for family engagement category options.");
                        });
                });
